...
| selectConfig            | 自定义选中文字弹窗不需要该功能不穿此参数即可 （可选）                                                                                                                                                                | `[{text: string;icon?: Component;style?: CSSProperties;onClick: (text: string, onCopy: (text: string) => void) => void; }]`                                                                                                                                                                                                                                                                              |
| threshold               | 阈值为 1.0 意味着目标元素完全出现在可视窗口 100% 可见时，pdf 页面会渲染触发 -默认 0.18（可选）                                                                                                                       | number                                                                                                                                                                                                                                                                                                                                                                                                   |
|                         |
